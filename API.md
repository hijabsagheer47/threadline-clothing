...
Postman, Insomnia or a Dart client generator. It is generated by
`scripts/build-openapi.py`, which fails if it drifts from the routes in
`api/v1/routes/`.
...
api/v1/openapi.json            generated spec
api/docs.html                  Swagger UI
scripts/build-openapi.py       regenerates and verifies the spec
```
